  ...
  instructions:
    ...
    sample_questions:
      ...
      - question: "What is the total budget allocated to Awareness campaigns?"
        answer: "I'll use CampaignAnalyst to sum campaigns.total_budget where campaigns.objective is 'AWARENESS'."
      - question: "Show me the top 5 social accounts by follower count."
        answer: "I'll use SocialPerformanceAnalyst to select profiles ranked by total_followers, limited to top 5."
      ...
      - question: "What is the churn risk distribution for Enterprise customers compared to Professional plans?"
        answer: "I'll use CustomerHealthAnalyst to analyze customers.churn_risk grouped by organizations.plan_tier for 'ENTERPRISE' and 'PROFESSIONAL'."
      - question: "Which campaign objective yields the highest ROI based on click-through rates?"
        answer: "I'll use CampaignAnalyst to calculate average campaigns.roi_score grouped by campaigns.objective."
      - question: "Correlate the number of open support tickets with customer churn risk scores."
        answer: "I'll use CustomerHealthAnalyst to analyze the relationship between tickets.total_tickets and customers.churn_risk."
      - question: "Identify the regions with the highest revenue but also highest churn risk."
        answer: "I'll use CustomerHealthAnalyst to analyze organizations grouped by organizations.country, showing customers.total_revenue and customers.avg_churn_risk."
      - question: "Predict the churn risk for all customers in the Manufacturing industry."
        answer: "I'll use PredictChurnRisk function with industry_filter 'MANUFACTURING' to get risk distribution."
      - question: "Forecast the ROI for our active Conversion campaigns."
        answer: "I'll use PredictCampaignROI function with objective_filter 'CONVERSION' to get ROI predictions."
      - question: "Classify the priority of tickets related to Billing issues."
        answer: "I'll use ClassifyTicketPriority function with category_filter 'BILLING' to get priority distribution."
      - question: "What is the predicted risk profile for customers with less than 6 months tenure?"
        answer: "I'll use PredictChurnRisk function with NULL filter to analyze all customers' risk profiles."
      - question: "Find support tickets related to login failure and their resolution notes."
        answer: "I'll use SupportTicketSearch to search for tickets containing 'login failure' or 'login issues'."
