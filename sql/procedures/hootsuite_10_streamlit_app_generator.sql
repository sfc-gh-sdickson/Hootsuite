...
st.download_button("📥 Download CSV", csv, "data.csv", use_container_width=True)
...
st.markdown("---")
st.caption("🤖 Auto-generated by Hootsuite Intelligence Agent")
"""
    
    try:
        # Create Streamlit app using AS $$code$$ syntax (no stage needed!)
        create_sql = f"""
        ...
        return {
            ...
            "app_name": app_name,
            "app_url": app_url,
            "message": f"✅ Streamlit app '{app_name}' deployed successfully!",
