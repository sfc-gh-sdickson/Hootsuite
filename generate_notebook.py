 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "**Note**: Using OrdinalEncoder for categorical features to ensure 1-to-1 column mapping."
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "\n",
    "# Define Pipeline\n",
    "# Using OrdinalEncoder to ensure explicit 1-to-1 column generation for the Classifier\n",
    ...
    "        input_cols=[\"PLAN_TYPE_ENC\", \"INDUSTRY_ENC\", \"EMPLOYEE_COUNT\", \"ANNUAL_REVENUE_MILLIONS\", \"TENURE_MONTHS\", \"SOCIAL_ACCOUNTS_COUNT\", \"TOTAL_TICKETS_LAST_90D\", \"URGENT_TICKET_RATE\"],\n",
    "        n_estimators=20,\n",
    "        max_depth=5\n",
    "    ))\n",
    "])\n",
    ...
    "    options={\"relax_version\": True, \"embed_local_ml_library\": True} \n",
    ")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Define Pipeline\n",
    "# ERROR FIX: Column is case-sensitive or doesn't match feature view. \n",
    "# Checking V_CAMPAIGN_ROI_FEATURES definition... it has 'OBJECTIVE'.\n",
    "# However, OrdinalEncoder might be sensitive to implicit capitalization if the dataframe was loaded weirdly.\n",
    "# BUT, the error is KeyError: 'OBJECTIVE' inside OrdinalEncoder.\n",
    "# This usually means the column isn't in the input dataframe or categories.\n",
    "# We will use uppercase explicitly and ensure it matches.\n",
    ...
    "        input_cols=[\"OBJECTIVE_ENC\", \"BUDGET_ALLOCATED\", \"DURATION_DAYS\", \"NUM_POSTS\", \"NUM_VIDEO_POSTS\"],\n",
    "        max_iter=100\n",
    "    ))\n",
    "])\n",
    "\n",
